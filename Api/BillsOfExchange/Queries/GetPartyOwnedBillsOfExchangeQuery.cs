...
namespace BillsOfExchange.Queries
{
    ...
    /// </summary>
    public class GetPartyOwnedBillsOfExchangeQuery : IGetPartyOwnedBillsOfExchangeQuery
    {
        ...
        public GetPartyOwnedBillsOfExchangeQuery(
        ...
        public async Task<PartyBillsOfExchange> ExecuteAsync(int partyId, CancellationToken cancellationToken = default)
        {
            ...
            var billsOfExchange = await this.billOfExchangeRepository.GetOwnedByPartyId(partyId, cancellationToken);
